...
const PRICES = {
  BR: {
    simple: { label: "Simples", price: 14.90, currency: "R$", perks: [
      "30 perguntas/dia",
      "Sem imagens",
      "12 agentes + Serginho (básico)",
    ]},
    medium: { label: "Médio", price: 24.90, currency: "R$", perks: [
      "100 perguntas/dia",
      "Até 30 imagens/mês",
      "Agentes mais inteligentes",
    ]},
    top: { label: "Top", price: 34.99, currency: "R$", perks: [
  ...
  EU: {
    simple: { label: "Simple", price: 9.90, currency: "€", perks: [
      "30 questions/day",
      "No images",
      "12 agents + Serginho (basic)",
    ]},
    medium: { label: "Medium", price: 14.99, currency: "€", perks: [
      "100 questions/day",
      "Up to 30 images/month",
      "Smarter agents",
    ]},
    top: { label: "Top", price: 19.99, currency: "€", perks: [
    ...
    <main style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      ...
      {Object.values(prices).map((plan, i) => (
        <div key={i} style={{
          ...
          <h2>{plan.label} — {plan.currency}{plan.price}/mês</h2>
          <ul>
