/**
 * RKMMAX + Claude 3.5 Sonnet Integration
...
class RKMMAXClaudeSystem {
  constructor() {
    ...
    console.log('🚀 RKMMAX + Claude 3.5 Sonnet inicializado');
  ...
  async processar(requisicao, opcoes = {}) {
    try {
      ...
      } else if (analise.especialista === 'tecnico') {
        resultado = await this.especialistas.especialistaTecnico(
          requisicao,
          { analise }
        );
      } else if (analise.especialista === 'abnt' || analise.requer_abnt) {
      ...
      if (opcoes.formatoABNT || analise.requer_abnt) {
      ...
      return {
        ...
        resultado: resultado,
        sistema: 'RKMMAX + Claude 3.5 Sonnet',
        suporte_imagem: true
      };
