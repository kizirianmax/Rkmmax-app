...
export default function Terms() {
  return (
    <div style={{ maxWidth: '900px', margin: '40px auto', padding: '20px' }}>
      ...
      <p>
        RKMMAX é uma plataforma de inteligência artificial com 54 especialistas para ajudar em:
      </p>
      <ul>
      ...
      <p>
        Cada plano tem limites diários de tokens:
      </p>
      <ul>
        <li><strong>Básico:</strong> 3.500 tokens/dia</li>
        <li><strong>Intermediário:</strong> 4.700 tokens/dia</li>
        <li><strong>Premium:</strong> 7.200 tokens/dia</li>
        <li><strong>Ultra:</strong> 9.000 tokens/dia</li>
      </ul>

      <h2>4. Proibições</h2>
      <p>
        Você não pode usar RKMMAX para:
      </p>
      <ul>
      ...
      <p>
        RKMMAX fornece o serviço "como está". Não somos responsáveis por:
      </p>
      <ul>
